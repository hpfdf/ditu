                    ...
                    PathArgument::Kind kind )
{
   if ( itInArg == in.end() )
   {
      // Error: missing argument %d
       std::cout << "Error: missing argument %d" << std::endl << path << std::endl;
   }
   else if ( (*itInArg)->kind_ != kind )
   {
      // Error: bad argument type
       std::cout << "Error: bad argument type" << std::endl << path << std::endl;
   }
   else
   {
...
{
   // Error: invalid path.
    std::cout << "Error: invalid path." << std::endl << path << " [" << location << "]" << std::endl;
}
      ...
      if ( arg.kind_ == PathArgument::kindIndex )
      {
         if ( !node->isArray()  ||  node->isValidIndex( arg.index_ ) )
         {
            // Error: unable to resolve path (array value expected at position...
             std::cout << " Error: unable to resolve path (array value expected at position..." << std::endl;
         }
      ...
      else if ( arg.kind_ == PathArgument::kindKey )
      {
         if ( !node->isObject() )
         {
            // Error: unable to resolve path (object value expected at position...)
             std::cout << " Error: unable to resolve path (object value expected at position...)" << std::endl;
         }
         node = &((*node)[arg.key_]);
         if ( node == &Value::null )
         {
            // Error: unable to resolve path (object has no member named '' at position...)
             std::cout << " Error: unable to resolve path (object has no member named '' at position...)" << std::endl;
         }
      }
   }
   return *node;
      ...
      if ( arg.kind_ == PathArgument::kindIndex )
      {
         if ( !node->isArray() )
         {
            // Error: node is not an array at position ...
             std::cout << " Error: node is not an array at position ..." << std::endl;
         }
         node = &((*node)[arg.index_]);
      }
      else if ( arg.kind_ == PathArgument::kindKey )
      {
         if ( !node->isObject() )
         {
            // Error: node is not an object at position...
             std::cout << " Error: node is not an object at position..." << std::endl;
         }
         node = &((*node)[arg.key_]);
      }
   }
